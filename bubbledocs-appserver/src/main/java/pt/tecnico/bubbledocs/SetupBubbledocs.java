...
public class SetupBubbledocs {
	...
	public static void populateDomain(){
		...
		bubble.addUser(new User("Paul Door","pf","sub"));
		bubble.addUser(new User("Step Rabbit","ra","cor"));
		...
		pfSpreadSheet.addContentToCell(3, 4, new Literal(5));
		pfSpreadSheet.addContentToCell(1, 1, new Reference(5,6));
		pfSpreadSheet.addContentToCell(5, 6, new ADD(new Literal(2),new Reference(3,4)));
